...
def test_hvac_integration():
    ...
    # Reuse existing QApplication or create one
    ...
    try:
        ...
        # Create project dashboard (do not start event loop in tests)
        ...
        # Close the dashboard to avoid lingering widgets in CI
        dashboard.close()
